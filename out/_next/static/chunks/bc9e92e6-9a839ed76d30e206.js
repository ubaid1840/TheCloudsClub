"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[358],{35002:function(t,e,i){var s,r,n,o,h=i(99279),l=i(42680),a=i(19053),u=i(71028),c=i(54565);i(20357),i(86300).Buffer;let d="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let f="10.11.1",g=new a.Yd("@firebase/firestore");function m(t,...e){if(g.logLevel<=a.in.DEBUG){let i=e.map(y);g.debug(`Firestore (${f}): ${t}`,...i)}}function E(t,...e){if(g.logLevel<=a.in.ERROR){let i=e.map(y);g.error(`Firestore (${f}): ${t}`,...i)}}function y(t){if("string"==typeof t)return t;try{/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function T(t="Unexpected state"){let e=`FIRESTORE (${f}) INTERNAL ASSERTION FAILED: `+t;throw E(e),Error(e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class S{static newId(){let t="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",e=Math.floor(256/t.length)*t.length,i="";for(;i.length<20;){let s=/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function(t){let e="undefined"!=typeof self&&(self.crypto||self.msCrypto),i=new Uint8Array(40);if(e&&"function"==typeof e.getRandomValues)e.getRandomValues(i);else for(let t=0;t<40;t++)i[t]=Math.floor(256*Math.random());return i}(0);for(let r=0;r<s.length;++r)i.length<20&&s[r]<e&&(i+=t.charAt(s[r]%t.length))}return i}}function D(t,e){return t<e?-1:t>e?1:0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class x{constructor(t,e,i,s){this.indexId=t,this.collectionGroup=e,this.fields=i,this.indexState=s}}function O(t){return"IndexedDbTransactionError"===t.name}x.UNKNOWN_ID=-1;/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class F{constructor(t,e){this.previousValue=t,e&&(e.sequenceNumberHandler=t=>this.ie(t),this.se=t=>e.writeSequenceNumber(t))}ie(t){return this.previousValue=Math.max(t,this.previousValue),this.previousValue}next(){let t=++this.previousValue;return this.se&&this.se(t),t}}F.oe=-1;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
